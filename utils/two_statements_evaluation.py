...
if __name__ == '__main__':
    ...
    json_judgment_2 = judgment_2.copy()  # Create a copy to avoid modifying the original

    eval_A = json_judgment_2.get("evaluation_A", {"score": None, "explanation": "Not parsed"})
    eval_A_score = eval_A.get("score", None)
    eval_B = json_judgment_2.get("evaluation_B", {"score": None, "explanation": "Not parsed"})
